<template>
  ...
  <div class="weditor">
    ...
    <div ref="editor" class="editor-content" :style="{ 'min-height': minHeight + 'px', 'max-height': maxHeight + 'px' }" :id="weditorId"></div>
  </div>
</template>
  ...
  export default {
    ...
    methods: {
      ...
      createWeditor() {
        ...
        // 配置编辑器菜单栏，设置不需要的菜单
        this.weditor.config.excludeMenus = this.excludeMenus;
        // 禁止展示全屏功能按钮
