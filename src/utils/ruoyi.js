      ...
      if (Object.hasOwnProperty.call(map, key)) {
        ...
        if (i == 0) {
          ...
          if (list[index].isAttachment) {
            ...
            if (list[index].lastValue instanceof Array) {
              console.log('22', JSON.stringify(list[index].lastValue));
              console.log('33', JSON.stringify(list[index].currValue));
              list[index].isDifferent = JSON.stringify(list[index].lastValue) != JSON.stringify(list[index].currValue);
            } else {
