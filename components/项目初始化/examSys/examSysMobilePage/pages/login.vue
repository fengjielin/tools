  ...
  <view class="normal-login-container">
    <view class="logo-content align-center justify-center flex">
      <image
        ...
        mode="widthFix"
        v-if="globalConfig.appInfo.logo"
      >
      </image>
      <text class="title">{{ globalConfig.appInfo.title }}</text>
    </view>
    ...
    <view class="login-form-content">
      ...
      <view style="display: flex; justify-content: space-between; margin-top: 20rpx">
        <navigator class="link-type" url="/pages/forgotPassword/index" open-type="navigate">找回密码</navigator>
        <navigator class="link-type" url="/pages/register/register" open-type="navigate" v-if="register">
          立即注册
        </navigator>
      </view>
    </view>
