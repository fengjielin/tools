<template>
	<view class="empty">
		<view class="empty-image" :style="{ width: imageSize ? imageSize + 'rpx' : '' }">
			<svg v-if="!image" viewBox="0 0 79 86" version="1.1" xmlns="http://www.w3.org/2000/svg"
				...
				<defs>
					...
					<rect rect id="path-3-1" x="0" y="0" width="17" height="36"></rect>
				</defs>
