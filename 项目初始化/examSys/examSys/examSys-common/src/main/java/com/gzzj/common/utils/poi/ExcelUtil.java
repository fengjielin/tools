package com.gzzj.common.utils.poi;
...
import com.gzzj.common.annotation.Excel.ColumnType;
import com.gzzj.common.annotation.Excel.Type;
import com.gzzj.common.annotation.Excels;
import com.gzzj.common.config.ExamSysConfig;
import com.gzzj.common.core.domain.AjaxResult;
import com.gzzj.common.core.text.Convert;
import com.gzzj.common.exception.UtilException;
import com.gzzj.common.utils.DateUtils;
import com.gzzj.common.utils.DictUtils;
import com.gzzj.common.utils.StringUtils;
import com.gzzj.common.utils.file.FileTypeUtils;
import com.gzzj.common.utils.file.FileUtils;
import com.gzzj.common.utils.file.ImageUtils;
import com.gzzj.common.utils.reflect.ReflectUtils;
...
public class ExcelUtil<T>
{
    ...
    public void setDataValidation(Excel attr, Row row, int column)
    {
        ...
        if(StringUtils.isNotEmpty(attr.dictType())) {//有字典 则取字典下拉
            setXSSFValidationWithHidden(sheet, DictUtils.getLabelArr(attr.dictType()),attr.prompt(), 1, 100, column, column);
        }else if(StringUtils.isNotEmpty(attr.classType())) {//有外键 则取类的属性下拉，getClassLabelArr是新加的方法。下面有写
            setXSSFValidationWithHidden(sheet, getClassLabelArr(attr.classType()),attr.prompt(),1, 100, column, column);
        }
    ...
    {
        String downloadPath = ExamSysConfig.getDownloadPath() + filename;
